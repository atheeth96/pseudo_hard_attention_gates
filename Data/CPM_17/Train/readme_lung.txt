This is the training dataset (NSCLC) for the digital pathology segmentation challenge. In this 
dataset there are 8 images. For each image, the dataset contains three files: 
...
The 8 images are extracted as rectangular tiles from whole slide tissue images at the 
